...
export function getSceneWordBudget(
  durationSec: number,
  sceneCount: number,
  format: string,
  language: "tr" | "en",
...
export function normalizeRefinedScenes(
  value: unknown,
...
export async function handleCreatorRefineScenesRequest(req: Request) {
  try {
    ...
    const refinedScenes = normalizeRefinedScenes(
      parsed.scenes,
      scenes,
      speechBudget,
      contentLanguage,
