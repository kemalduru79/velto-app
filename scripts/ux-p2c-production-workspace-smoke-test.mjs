...
const page = requireNeedles("app/create/page.tsx", [
  ...
  'className="creatorlab-p2c-focused-scene-heading min-w-0 flex-1"',
  ...
  'uiLanguage === "en" ? `Selected Scene ${String(index + 1).padStart(2, "0")}`',
...
requireNeedles("components/auth/UserAccountMenu.tsx", ["UserAccountMenu"]);
