...
const expected = {
  standard: { price: 59, minutes: 60, salePerMinute: 59 / 60, credits: 700 },
  pro: { price: 199, minutes: 90, salePerMinute: 199 / 90, credits: 2600 },
  cinematic: { price: 399, minutes: 60, salePerMinute: 399 / 60, credits: 3200 },
};
