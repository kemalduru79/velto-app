...
assert.match(component, /Rewrite section with AI/);
assert.match(component, /Confirm the edit only after checking the supporting sources/);
assert.doesNotMatch(component, /Regenerate to verify/);
