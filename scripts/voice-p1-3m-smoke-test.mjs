...
const assertions = [
  ...
  [sources.page.includes("Narrator delivery for this scene"), "scene narrator delivery override"],
  [sources.page.includes("Dialogue delivery for this scene"), "scene dialogue delivery override"],
  [sources.page.includes("getCreatorVoiceCreditEstimate(scenes).totalTracks"), "voice credit estimate"],
