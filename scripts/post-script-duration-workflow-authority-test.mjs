...
assert.doesNotMatch(scriptBuildCatch, /setCreatorScript\(|setCreatorProductionPackage\(|setScenes\(/);
assert.match(scriptBuildCatch, /Your existing script is unchanged/);
