...
check("dependency manifest contains only the new test commands", () => assert.equal(sha256("package.json"), "7c9fc217fe413cc41f572a771dee7bb2e801dd99a271df1ebf782ee1b90a1b75"));
...
check("Stage 0.8 closure worktree scope permits only reviewed later-stage additions", () => {
  const allowed = new Set([
    ...
    "docs/stock-library-credit-productization.md",
    "lib/credits/operationPolicy.ts",
    "lib/credits/serverMetering.ts",
    "scripts/stock-library-credit-productization-test.mjs",
  ]);
